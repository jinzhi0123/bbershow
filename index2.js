...
hexo.extend.filter.register('after_generate', function () {
    ...
    if (!(config && config.enable)) return
        ...
        custom_css: config.custom_css ? urlFor(config.custom_css) : "https://cdn.jsdelivr.net/gh/jinzhi0123/bbershow/lib/bbr_index.css",
        custom_js: config.custom_js ? urlFor(config.custom_js) : "https://cdn.jsdelivr.net/gh/jinzhi0123/bbershow/lib/bbr_index.js"
        }
    // 渲染页面
    ...
    //脚本资源
    const js_text = `<script defer src="${data.custom_js}"></script><script defer data-pjax src="https://cdn.jsdelivr.net/gh/jinzhi0123/bbershow/lib/bbr_index.js"></script>`
    //注入容器声明
    var get_layout
    //若指定为class类型的容器
    ...
    hexo.extend.helper.register('priority', function(){
        ...
        const pre_priority = hexo.config.bbershow.priority || hexo.theme.config.bbershow.priority
